...
public class TextButton extends Button {
	...
	public TextButton (String text, Skin skin) {
		this(text, skin.get(TextButtonStyle.class) , false , 0);
		setSkin(skin);
	}

	public TextButton (String text, Skin skin, String styleName) {
		this(text, skin.get(styleName, TextButtonStyle.class) , false , 0);
		setSkin(skin);
	}
	...
	public TextButton (String text, TextButtonStyle style)
	{
		...
		this(text, style, false , 0);
		
	}

	public TextButton (String text, TextButtonStyle style , boolean useWrapping, int extraPadding) {
		super(style);
		this.style = style;
		...
		this.pad(getPadTop() + extraPadding, getPadLeft(), getPadBottom() + extraPadding, getPadRight());
