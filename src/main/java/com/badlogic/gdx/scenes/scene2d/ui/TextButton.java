...
public class TextButton extends Button {
	...
	public TextButton(String text, TextButtonStyle style, boolean useWrapping,
			int extraPadding) {
		super(style);
		this.style = style;
		...
		this.pad(getPadTop() + extraPadding, getPadLeft(), getPadBottom()
				+ extraPadding, getPadRight());
