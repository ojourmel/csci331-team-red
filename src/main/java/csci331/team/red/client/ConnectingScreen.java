...
public class ConnectingScreen implements Screen {
	...
	public ConnectingScreen(ClientEngine parent) {
		...
		// Creates our buttons
		TextButton ConnectionLabel = new TextButton(
		...
		connectAddress.setWidth(parentEngine.gameFont
				.getBounds("Enter hostname or IP!").width + 20);
		...
		ConnectionLabel.setPosition(Gdx.graphics.getWidth() / 2
				- ConnectionLabel.getWidth() / 2, (Gdx.graphics.getHeight()
				/ (connectingStage.getActors().size + 1) * 3));

		connectAddress.setPosition(
				Gdx.graphics.getWidth() / 2 - connectAddress.getWidth() / 2,
				(Gdx.graphics.getHeight()
						/ (connectingStage.getActors().size + 1) * 2));

		Backbutton.setPosition(
				Gdx.graphics.getWidth() / 2 - Backbutton.getWidth() / 2,
				(Gdx.graphics.getHeight()
						/ (connectingStage.getActors().size + 1) * 1));
