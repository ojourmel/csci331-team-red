...
public class DialogueWindow extends TextButton {
	...
	public DialogueWindow(String dialogue, String thespeaker,
			TextButtonStyle style, Stage parentStage) {
		this(dialogue, thespeaker, style, parentStage, false, 0, true, null,
				null);
	}

	public DialogueWindow(String dialogue, String thespeaker,
			TextButtonStyle style, Stage parentStage, DialogueWindow nextWindow) {
		this(dialogue, thespeaker, style, parentStage, false, 0, true, null,
				null);
	}

	public DialogueWindow(String dialogue, String thespeaker,
			TextButtonStyle style, Stage parentStage, boolean useWordWrap,
			int extraPadding, Boolean displayNow, DialogueWindow nextWindow,
			Enum<?> c) {
		this(dialogue, thespeaker, style, parentStage, useWordWrap,
				extraPadding, displayNow, nextWindow, c, Gdx.graphics
						.getHeight());
	}
	...
	public DialogueWindow(String dialogue, String thespeaker,
		...
		this.addListener(new ClickListener() {
			...
			public void clicked(InputEvent event, float x, float y) {
				DialogueWindow thisActor = (DialogueWindow) event
						.getListenerActor();
				...
				if (thisActor.Callbackcode != null) {
					...
					try {
						Class<?> c = thisActor.Callbackcode.getClass()
								.getDeclaringClass();
