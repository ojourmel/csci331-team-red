...
public class ClientEngine extends Game {
	...
	public void create() {
		...
		// Backgrounds...
		Textures.put("level1fieldbg", new AssetDescriptor<Texture>(
				"backgrounds/level1fieldagent.jpg", Texture.class));
		Textures.put("level1databasebg", new AssetDescriptor<Texture>(
				"backgrounds/level1databaseagent.png", Texture.class));
		Textures.put("level2fieldbg", new AssetDescriptor<Texture>(
		...
		// Characters...
		Pixmaps.put("level1thug", new AssetDescriptor<Pixmap>(
				"characters/level1thug.png", Pixmap.class));
		Pixmaps.put("level1male", new AssetDescriptor<Pixmap>(
				"characters/maleExtra.png", Pixmap.class));
		Pixmaps.put("level1female", new AssetDescriptor<Pixmap>(
				"characters/femaleExtra.png", Pixmap.class));

		// Dynamic Props...
		Pixmaps.put("goldenTicket", new AssetDescriptor<Pixmap>(
