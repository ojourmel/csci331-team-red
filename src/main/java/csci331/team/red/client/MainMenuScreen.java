...
public class MainMenuScreen implements Screen {
	...
	public MainMenuScreen(ClientEngine parent) {
		...
		backgroundImage = parentEngine.gameTextureManager
				.get(parentEngine.Textures.get("level2fieldbg"));
		...
		// Creates our buttons
		TextButton ConnectButton = new TextButton("Connect",
				parentEngine.buttonStyle);
		...
		TextButton ListenButton = new TextButton("Host",
				parentEngine.buttonStyle);
		...
		TextButton TestLevelOneFieldButton = new TextButton(
				"Test Level One (Field Agent)", parentEngine.buttonStyle);
		...
		TextButton TestLevelOneDBButton = new TextButton(
				"Test Level One (DB Agent)", parentEngine.buttonStyle);
		...
		ConnectButton.setPosition(
				Gdx.graphics.getWidth() / 2 - ConnectButton.getWidth() / 2,
				(Gdx.graphics.getHeight()
						/ (mainMenuStage.getActors().size + 1) * 6));
		ListenButton.setPosition(
				Gdx.graphics.getWidth() / 2 - ListenButton.getWidth() / 2,
				(Gdx.graphics.getHeight()
						/ (mainMenuStage.getActors().size + 1) * 5));
		TestLevelOneFieldButton.setPosition(Gdx.graphics.getWidth() / 2
				- TestLevelOneFieldButton.getWidth() / 2,
				(Gdx.graphics.getHeight()
						/ (mainMenuStage.getActors().size + 1) * 4));
		TestLevelOneDBButton.setPosition(Gdx.graphics.getWidth() / 2
				- TestLevelOneDBButton.getWidth() / 2,
				(Gdx.graphics.getHeight()
						/ (mainMenuStage.getActors().size + 1) * 3));
		SettingsButton.setPosition(
				Gdx.graphics.getWidth() / 2 - SettingsButton.getWidth() / 2,
				(Gdx.graphics.getHeight()
						/ (mainMenuStage.getActors().size + 1) * 2));
		QuitButton.setPosition(
				Gdx.graphics.getWidth() / 2 - QuitButton.getWidth() / 2,
				(Gdx.graphics.getHeight()
						/ (mainMenuStage.getActors().size + 1) * 1));
