...
public class SettingsScreen implements Screen {
	...
	public SettingsScreen(ClientEngine parent) {
		...
		// Creates our buttons
		TextButton SettingsLabel = new TextButton("No settings lol",
		...
		SettingsLabel.setPosition(
				Gdx.graphics.getWidth() / 2 - SettingsLabel.getWidth() / 2,
				(Gdx.graphics.getHeight() / 5 * 4));
		BackButton.setPosition(
				Gdx.graphics.getWidth() / 2 - BackButton.getWidth() / 2,
				(Gdx.graphics.getHeight()
						/ (settingsStage.getActors().size + 1) / 5));
