package csci331.team.red.client.tweeningFunctions;

import csci331.team.red.client.Raindrop;
import aurelienribon.tweenengine.TweenAccessor;

public class RaindropTweener implements TweenAccessor<Raindrop> {
    ...
    @Override
    public int getValues(Raindrop target, int tweenType, float[] returnValues) {
        switch (tweenType) {
    ...
    @Override
    public void setValues(Raindrop target, int tweenType, float[] newValues) {
        switch (tweenType) {
